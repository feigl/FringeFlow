...
# set up for MintPy
if [[ -d /home/mambauser/MintPy ]]; then
    export MINTPY_HOME=/home/mambauser/MintPy
...
if [[ -d /home/mambauser/PyAPS ]]; then
    export PYTHONPATH=${PYTHONPATH}:/home/mambauser/PyAPS
    export PYTHONPATH=${PYTHONPATH}:/home/mambauser/PyAPS/pyaps3
fi
