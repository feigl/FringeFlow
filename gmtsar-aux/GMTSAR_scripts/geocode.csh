...
#  Elena Reinisch 20160909 uncommented p2p_ra2ll.csh line for phase_ll.grd
#  Elena Reinisch 20160912 changed geocoding for wrapped phase, separate into real and imaginary parts before geocoding, do not geocode unnecessary files, do not make google earth image 
#
alias rm 'rm -f'
unset noclobber
#
...
# geocode real and imaginary parts of phase separately
# original phase
gmt grdmath phase.grd SIN = im_phase.grd
gmt grdmath phase.grd COS = re_phase.grd
proj_ra2ll.csh trans.dat im_phase.grd im_phase_ll.grd
proj_ra2ll.csh trans.dat re_phase.grd re_phase_ll.grd
gmt grdmath im_phase_ll.grd re_phase_ll.grd ATAN2 = phase_ll.grd	; gmt grdedit -D//"radians"/1///"$PWD:t wrapped phase"/"$remarked"                   phase_ll.grd
# original phase
#proj_ra2ll.csh trans.dat imag.grd im_phase_org_ll.grd
#proj_ra2ll.csh trans.dat real.grd re_phase_org_ll.grd
#gmt grdmath im_phase_org_ll.grd re_phase_org_ll.grd ATAN2 = phase_org_ll.grd        ; gmt grdedit -D//"radians"/1///"$PWD:t wrapped phase"/"$remarked"                   phase_org_ll.grd

# masked phase
 gmt grdmath phase_mask.grd SIN = im_phase_mask.grd
 gmt grdmath phase_mask.grd COS = re_phase_mask.grd
 proj_ra2ll.csh trans.dat im_phase_mask.grd im_phase_mask_ll.grd
 proj_ra2ll.csh trans.dat re_phase_mask.grd re_phase_mask_ll.grd
 gmt grdmath im_phase_mask_ll.grd re_phase_mask_ll.grd ATAN2 = phase_mask_ll.grd        ; gmt grdedit -D//"radians"/1///"$PWD:t wrapped phase"/"$remarked"                   phase_mask_ll.grd


# filtered phase
gmt grdmath phasefilt.grd SIN = im_phasefilt.grd
gmt grdmath phasefilt.grd COS = re_phasefilt.grd
proj_ra2ll.csh trans.dat im_phasefilt.grd im_phasefilt_ll.grd
proj_ra2ll.csh trans.dat re_phasefilt.grd re_phasefilt_ll.grd
gmt grdmath im_phasefilt_ll.grd re_phasefilt_ll.grd ATAN2 =   phasefilt_ll.grd      ; gmt grdedit -D//"radians"/1///"$PWD:t wrapped phase after filtering"/"$remarked"   phasefilt_ll.grd

# filtered phase
 gmt grdmath phasefilt_mask.grd SIN = im_phasefilt_mask.grd
 gmt grdmath phasefilt_mask.grd COS = re_phasefilt_mask.grd
 proj_ra2ll.csh trans.dat im_phasefilt_mask.grd im_phasefilt_mask_ll.grd
 proj_ra2ll.csh trans.dat re_phasefilt_mask.grd re_phasefilt_mask_ll.grd
 gmt grdmath im_phasefilt_mask_ll.grd re_phasefilt_mask_ll.grd ATAN2 =   phasefilt_mask_ll.grd      ; gmt grdedit -D//"radians"/1///"$PWD:t wrapped phase after filtering"/"$remarked"   phasefilt_mask_ll.grd
