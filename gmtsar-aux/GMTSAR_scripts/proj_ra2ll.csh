...
# use a 20 m grid for Brady demcut_ll.grd spacing (delta lat/lon = 0.0002)
# first set of ticks: returns dimensions of grid to nearest 7.2 seconds (x 10 of res. in arc sec.)
# note: can also specify -I in meters (append e instead of s for seconds)
 ...
 #
  gmt blockmedian llp `gmt gmtinfo llp -I200e -bi3f ` -bi3f -bo3f -I20e -r -V > llpb
  gmt xyz2grd llpb `gmt gmtinfo llpb -I200e -bi3f ` -I20e -r -fg -G$3 -bi3f


# grid for Coso dem.grd spacing (delta lat/lon = 0.000833333333333), ~60 m
# #
#  gmt blockmedian llp `gmt gmtinfo llp -I30s -bi3f ` -bi3f -bo3f -I3s -r -V > llpb
#  gmt xyz2grd llpb `gmt gmtinfo llpb -I30s -bi3f ` -I3s -r -fg -G$3 -bi3f
#
